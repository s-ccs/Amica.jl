...
try
    ...
    @testset "basic tests" begin
        ...
        raw = read_fdt(
            joinpath(fortran_without_newton, "raw_data_seg_1.bin");
            ncols = 19,
            T = Float64,
            transpose = true,
        )
        ...
        sphered = read_fdt(
            joinpath(fortran_without_newton, "sphere_data_seg_1.bin");
            ncols = 19,
            T = Float64,
            transpose = true,
        )
    ...
    @testset "compare without newton" begin
        ...
        sbeta = read_fdt(
            joinpath(fortran_without_newton, "sbeta.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        rho = read_fdt(
            joinpath(fortran_without_newton, "rho.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        mu = read_fdt(
            joinpath(fortran_without_newton, "mu.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        Amica.amica!(
            ...
            newt_start_iter = 50,
            data_inplace = false;
            dump_dir = julia_without_newton,
        )

        b_fortran =
            read_fdt(
                joinpath(fortran_without_newton, "b.bin");
                ncols = 2 * N,
                T = Float64,
                transpose = true,
            )[
        ...
        b_julia = read_fdt(
            joinpath(julia_without_newton, "source_signals.bin");
            ncols = N,
            T = Float64,
        )
        ...
        g_fortran =
            read_fdt(
                joinpath(fortran_without_newton, "g_after_iter1.bin");
                ncols = 2 * N,
                T = Float64,
                transpose = true,
            )[
        ...
        y_fortran = read_3d_fdt(
            joinpath(fortran_without_newton, "y.bin");
            ncols = 2 * N,
            nslabs = 3,
            T = Float64,
        )[
        ...
        y_julia = read_3d_fdt(
            joinpath(julia_without_newton, "y.bin");
            ncols = N,
            nslabs = 3,
            T = Float64,
        )
        ...
        z_fortran = read_3d_fdt(
            joinpath(fortran_without_newton, "z.bin");
            ncols = 2 * N,
            nslabs = 3,
            T = Float64,
        )[
        ...
        z_julia = read_3d_fdt(
            joinpath(julia_without_newton, "z.bin");
            ncols = N,
            nslabs = 3,
            T = Float64,
        )
        ...
        Ptmp = read_fdt(
            joinpath(fortran_without_newton, "Ptmp.bin");
            ncols = 2 * N,
            T = Float64,
        )[
            1:N,
        ...
        LL =
            read_fdt(joinpath(fortran_without_newton, "LL.bin"); ncols = 1, T = Float64)[
                1,
                :,
            ]'
        ...
        mu_1 = read_fdt(
            joinpath(fortran_without_newton, "mu_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        sbeta_1 = read_fdt(
            joinpath(fortran_without_newton, "sbeta_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        rho_1 = read_fdt(
            joinpath(fortran_without_newton, "rho_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        A_1 = read_fdt(
            joinpath(fortran_without_newton, "a_after_iter1.bin");
            ncols = 19,
            T = Float64,
        )
        @test myAmica.A ≈ A_1
        ...
        alpha = read_fdt(
            joinpath(fortran_without_newton, "alpha_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
    ...
    @testset "compare with newton" begin
        ...
        sbeta = read_fdt(
            joinpath(fortran_with_newton, "sbeta.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        rho = read_fdt(
            joinpath(fortran_with_newton, "rho.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        mu = read_fdt(
            joinpath(fortran_with_newton, "mu.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        Amica.amica!(
            ...
            newt_start_iter = 0,
            data_inplace = false;
            dump_dir = julia_with_newton,
        )

        b_fortran =
            read_fdt(
                joinpath(fortran_with_newton, "b.bin");
                ncols = 2 * N,
                T = Float64,
                transpose = true,
            )[
        ...
        b_julia = read_fdt(
            joinpath(julia_with_newton, "source_signals.bin");
            ncols = N,
            T = Float64,
        )
        @test b_fortran ≈ b_julia
        ...
        g_fortran =
            read_fdt(
                joinpath(fortran_with_newton, "g_after_iter1.bin");
                ncols = 2 * N,
                T = Float64,
                transpose = true,
            )[
        ...
        y_fortran = read_3d_fdt(
            joinpath(fortran_with_newton, "y.bin");
            ncols = 2 * N,
            nslabs = 3,
            T = Float64,
        )[
        ...
        y_julia = read_3d_fdt(
            joinpath(julia_with_newton, "y.bin");
            ncols = N,
            nslabs = 3,
            T = Float64,
        )
        ...
        z_fortran = read_3d_fdt(
            joinpath(fortran_with_newton, "z.bin");
            ncols = 2 * N,
            nslabs = 3,
            T = Float64,
        )[
        ...
        z_julia = read_3d_fdt(
            joinpath(julia_with_newton, "z.bin");
            ncols = N,
            nslabs = 3,
            T = Float64,
        )
        ...
        Ptmp =
            read_fdt(joinpath(fortran_with_newton, "Ptmp.bin"); ncols = 2 * N, T = Float64)[
                1:N,
                1,
            ]
        @test Ptmp ≈ myAmica.Lt
        ...
        LL =
            read_fdt(joinpath(fortran_with_newton, "LL.bin"); ncols = 1, T = Float64)[1, :]'
        @test LL[1] ≈ myAmica.LL[1]

        mu_1 = read_fdt(
            joinpath(fortran_with_newton, "mu_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        sbeta_1 = read_fdt(
            joinpath(fortran_with_newton, "sbeta_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        rho_1 = read_fdt(
            joinpath(fortran_with_newton, "rho_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
        ...
        A_1 = read_fdt(
            joinpath(fortran_with_newton, "a_after_iter1.bin");
            ncols = 19,
            T = Float64,
        )
        @test myAmica.A ≈ A_1
        ...
        kappa = read_fdt(
            joinpath(fortran_with_newton, "kappa_after_iter1.bin");
            ncols = 19,
            T = Float64,
        )
        ...
        lambda = read_fdt(
            joinpath(fortran_with_newton, "lambda_after_iter1.bin");
            ncols = 19,
            T = Float64,
        )
        @test myAmica.newton_lambda ≈ lambda
        sigma2 = read_fdt(
            joinpath(fortran_with_newton, "sigma2_after_iter1.bin");
            ncols = 19,
            T = Float64,
        )
        ...
        alpha = read_fdt(
            joinpath(fortran_with_newton, "alpha_1.bin");
            ncols = 3,
            T = Float64,
            transpose = true,
        )
    ...
    @testset "full run" begin
        ...
        fortran_LL =
            vec(read_fdt(joinpath(fortran_output_dir, "LL"); ncols = 1, T = Float64))
